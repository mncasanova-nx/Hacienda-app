    ...
    var stockHTML = CAMPOS.map(function(campo) {
      ...
      movimientos.forEach(function(m){
        ...
        if(esMiCampo){
          ...
          else if(m.tipo==="cambio_categoria"){ tot[m.categoria]=(tot[m.categoria]||0)-Number(m.cantidad); if(m.categoriaDestino) tot[m.categoriaDestino]=(tot[m.categoriaDestino]||0)+Number(m.cantidad); }
        }
