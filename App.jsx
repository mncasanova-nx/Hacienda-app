...
function calcularStock(corrales, movs) {
  ...
  movs.forEach(function(m){
    ...
    else if(m.tipo==="salida"||m.tipo==="muerte"||m.tipo==="traslado_externo"){
      if(stock[m.corral]) stock[m.corral][m.categoria]=(stock[m.corral][m.categoria]||0)-Number(m.cantidad);
    }
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                ...
                <div>
                  ...
                  {(function(){
                    ...
                    var tiposQueDescuentan=["salida","muerte","traslado_externo","mov_interno","traslado_campos","cambio_categoria"];
