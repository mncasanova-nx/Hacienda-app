...
export default function App() {
  ...
  var exportarPDF = function() {
    ...
    script.onload = function() {
      ...
      var doc = new jsPDF();
      var campo = CAMPOS.find(function(c){ return c.id===campoFiltro; });
      var nombreCampo = campo ? campo.nombre : "Todos los campos";
      
      // Header
      doc.setFillColor(15, 17, 23);
      doc.rect(0, 0, 210, 30, "F");
      doc.setTextColor(229, 220, 200);
      doc.setFontSize(18);
      doc.setFont("helvetica","bold");
      doc.text("Stock HyH Ganadera", 14, 15);
      doc.setFontSize(10);
      doc.setFont("helvetica","normal");
      doc.setTextColor(181, 146, 90);
      doc.text("Campo: "+nombreCampo+" | Generado: "+fmtFecha(todayStr()), 14, 23);
      ...
      movFiltrados.forEach(function(m, i) {
        var cn = corralNombre;
        var txt = "";
        ...
        if(m.observaciones) txt += " Obs: "+m.observaciones;
      ...
      for(var p = 1; p <= pageCount; p++) {
        ...
        doc.text("Página "+p+" de "+pageCount+" | Stock HyH Ganadera", 14, 290);
      }
      
      doc.save("reporte-hacienda-"+todayStr()+".pdf");
    };
  ...
  const navItems=[["registrar","＋ Registrar"],["mixer","🚛 Mixer"],["suplementacion","🌿 Suplementación"],["historial","Historial"],["reporte","Reporte"],["lotes","Lotes"],["stock","Stock"]];
  ...
  return (
    <div style={{minHeight:"100vh",background:"#0f1117",color:"#e8e3d8",fontFamily:"Georgia,serif"}}>
      ...
      <div style={{background:"#161a24",borderBottom:"1px solid #2a2f3e",padding:"14px 20px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:10}}>
        <div style={{fontSize:20,fontWeight:700,color:"#e8dcc8"}}>📋 Stock HyH Ganadera</div>
          ...
          <div style={{display:"grid",gap:14}}>
            ...
            <div style={S.card}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:10}}>
                ...
                <button onClick={function(){ exportarPDF(); }} style={{background:"#3a1a1a",color:"#f87171",border:"1px solid #f8717155",borderRadius:8,padding:"9px 20px",cursor:"pointer",fontSize:13,fontWeight:700}}>📄 Exportar PDF</button>
              </div>
            </div>
            <div id="reporte-pdf" style={S.card}>
